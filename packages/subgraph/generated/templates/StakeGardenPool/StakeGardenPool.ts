...
export class StakeGardenPool extends ethereum.SmartContract {
  static bind(address: Address): StakeGardenPool {
    return new StakeGardenPool("StakeGardenPool", address);
  }
  ...
  stakeTokens(param0: BigInt): Address {
    let result = super.call("stakeTokens", "stakeTokens(uint256):(address)", [
  ...
  try_stakeTokens(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "stakeTokens",
...
export class ConstructorCall__Inputs {
  ...
  get _stakeTokens(): Array<Address> {
